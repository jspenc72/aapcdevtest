...
// Pallet based on http://paletton.com/#uid=4000u0knfrn7uOcgMwOswlADIdP
$brand-primary:             #0B6767;
$brand-highlight:           #DA3C3C; //not a replacement; just adding a contrasting highlight color
$brand-success:             #9BCC38;
$brand-info:                #4A9C9C;
$brand-warning:             #FF7979;
$brand-danger:              #DA3C3C;
...
$state-success-bg:               #9BCC38 !default;
$state-success-text:             darken($state-success-bg, 20%) !default;
$state-success-border:           darken($state-success-bg, 5%) !default;

$state-info-bg:                  #4A9C9C !default;
$state-info-text:                darken($state-info-bg, 20%) !default;
$state-info-border:              darken($state-info-bg, 7%) !default;

$state-warning-bg:               #FF7979 !default;
$mark-bg:                        $state-warning-bg !default;
$state-warning-text:             darken($state-warning-bg, 40%) !default;
$state-warning-border:           darken($state-warning-bg, 5%) !default;

$state-danger-bg:                #DA3C3C !default;
$state-danger-text:              darken($state-danger-bg, 25%) !default;
